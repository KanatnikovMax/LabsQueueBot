...
{
    /// <inheritdoc />
    public partial class Adding_UserRoleRepository_Migration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubjectRepository_CourseNumber_GroupNumber_SubjectName",
                table: "SubjectRepository",
                columns: new[] { "CourseNumber", "GroupNumber", "SubjectName" },
                unique: true);
        }
